...
#Next, create a function that allows you to add things to that list. Anything that's passed to this function 
#should get added to myUniqueList, unless its value already exists in myUniqueList. If the value doesn't exist already, 
#it should be added and the function should return True. If the value does exist, it should not be added, and the function should return False;
...
# function to check if availability of the value entered.
def addToApprioriateList(value):
...
# print out elements. 
print(addToApprioriateList(userValue));
print(myUniqueList);
print(myLeftovers);
